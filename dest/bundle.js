...
var _movie = __webpack_require__(329);

var rambo = new _movie.Movie("rambo", 8.1);
var rocky = new _movie.Movie("rocky", 8.0);
var equlizer = new _movie.Movie("equalizew", 5.4);
var terminator = new _movie.Movie("terminator", 6.5);
...
niz.filter(function (movie) {
  return movie.imdb >= 8;
}).forEach(function (val, ind) {
  console.log(val.imdb, val.getName());
});
function klik() {
